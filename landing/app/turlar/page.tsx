      ...
      <section className="tr-page-pad" style={{ background: '#FAFAFA', padding: '48px 48px 60px' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
          ...
          {displayed.length === 0 ? (
            ...
            <>
              <div className="tr-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px' }}>
              ...
              {allTours.length > 12 && (
                <div style={{ textAlign: 'center', marginTop: '48px' }}>
                  <Link href="/etkinlikler" className="tr-all-btn">
                    Tüm Etkinlikleri Gör ({allTours.length})
          ...
          <div style={{ display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <a href="#" aria-label="Google Play" style={{ display: 'inline-flex', alignItems: 'center', gap: '7px', background: '#000', border: '1px solid rgba(255,255,255,0.18)', borderRadius: '9px', padding: '5px 11px', textDecoration: 'none' }}>
              <svg width="16" height="18" viewBox="0 0 20 22">
                <path d="M.414.75C.155.99 0 1.393 0 1.924v18.152c0 .531.155.934.42 1.168l.062.057 10.17-10.17v-.238L.476.693.414.75z" fill="url(#gp_a2)"/>
                <path d="M14.038 14.526l-3.386-3.395v-.238l3.387-3.387.077.044 4.01 2.278c1.145.65 1.145 1.716 0 2.367l-4.01 2.278-.078.053z" fill="url(#gp_b2)"/>
                <path d="M14.116 14.473L10.652 11 .414 21.244c.378.4.999.45 1.703.05l12-6.82" fill="url(#gp_c2)"/>
                <path d="M14.116 7.527L2.117.707C1.413.302.792.357.414.757L10.652 11l3.464-3.473z" fill="url(#gp_d2)"/>
                <defs>
                  <linearGradient id="gp_a2" x1="9.81" y1="1.809" x2="-4.638" y2="16.257" gradientUnits="userSpaceOnUse"><stop stopColor="#00A0FF"/><stop offset="1" stopColor="#00E3FF"/></linearGradient>
                  <linearGradient id="gp_b2" x1="20.318" y1="11" x2="-.033" y2="11" gradientUnits="userSpaceOnUse"><stop stopColor="#FFE000"/><stop offset="1" stopColor="#FF9C00"/></linearGradient>
                  <linearGradient id="gp_c2" x1="12.072" y1="13.002" x2="-8.036" y2="33.11" gradientUnits="userSpaceOnUse"><stop stopColor="#FF3A44"/><stop offset="1" stopColor="#C31162"/></linearGradient>
                  <linearGradient id="gp_d2" x1="-1.934" y1="-7.697" x2="7.515" y2="1.751" gradientUnits="userSpaceOnUse"><stop stopColor="#32A071"/><stop offset="1" stopColor="#00F076"/></linearGradient>
                </defs>
              </svg>
              <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.2 }}>
